...
import { X, Play, ChevronLeft, ChevronRight, Camera, Video, Grid3X3, LayoutGrid } from "lucide-react"
    ...
    <section className="relative min-h-screen overflow-hidden bg-[#0a0014] py-24">
      ...
      {modalAbierto && itemModal && (
        ...
        >
          ...
          <div 
            className="relative max-h-[85vh] w-full max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-linear-to-br from-white/10 to-white/5 p-1 backdrop-blur-xl"
