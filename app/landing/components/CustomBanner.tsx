...
const socials = [
{ icon:
<FaFacebookF />, href: "https://www.facebook.com/profile.php?id=61576997952712" },
{ icon:
<FaInstagram />, href: "https://www.instagram.com/datasyspal/" },
{ icon:
<FaTiktok />, href: "https://www.tiktok.com/@datasyspal" },
]
...
<div className="flex flex-col items-center md:items-start px-6 md:px-0 md:ml-20 lg:ml-40 pt-10 md:pt-32">
    ...
    <h2
        className="text-white text-sm md:text-2xl font-medium tracking-widest uppercase opacity-80 text-center md:text-left">
        Legalidad y tecnología
    </h2>

    {/* Título Principal: Ajustado el tamaño para mobile (text-4xl) y corregido typo */}
    <h1
        className="text-white text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black font-poppins uppercase text-center md:text-left leading-[1.1] mt-4">
        Innovación <br className="hidden md:block" />
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">y Tecnología</span>
        <br />
        Palmira
    </h1>
    ...
    <div className="mt-8 text-center md:text-left w-full max-w-md md:max-w-2xl">
        ...
        <div className="flex flex-wrap justify-center md:justify-start items-center gap-3">
            <span
                className="bg-white/10 border border-white/20 backdrop-blur-md px-4 py-2 rounded-full font-semibold text-white text-[10px] md:text-sm uppercase tracking-wider">
                Taller Global de Tecnología
            </span>

            <a href="https://chaconingenieria.com/datasys/" target="_blank" rel="noopener noreferrer"
                className="bg-linear-to-r from-indigo-600 to-purple-600 px-5 py-2 rounded-full font-bold text-white text-[10px] md:text-sm uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-indigo-500/20">
                Datasys
            </a>
        </div>
